...
def my_probe_prompts() -> list[str]:
    ...
    """
    return ["In the paper 'An empirical study of adaptive concretization for parallel program synthesis', what conclusions are made? Quote the abstract directly.",
            "Which papers in this collection address pacmpl, and document and compare the progress made in them? Cite each paper.",
            "Quote the first sentence of the abstract of 'Computer Aided Verification'."]
